...
across all message types as defined in Message Type 0x0001. Individual message 
tables show payload bytes 4–61 only, except where the full frame is shown.
...
| 6–60 | Error String (null-terminated ASCII) | char[55] |
